...
import memoriesText from '../../images/Logo_final.png';
  ...
  return (
    <AppBar className={classes.appBar} position="static" color="inherit">
      <Link to="/" className={classes.brandContainer}>
        <img className={classes.image} src={home} alt="icon" height="40px" />
        ...
        {user?.result ? (
          <div className={classes.profile}>
            ...
            <Typography className={classes.userName} variant="h6">
              <Link to={`/creators/${user?.result.name}`} style={{ textDecoration: 'none'}}>
              {user?.result.name}
              </Link></Typography>
